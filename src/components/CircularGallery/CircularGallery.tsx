...
function debounce<T extends (...args: unknown[]) => void>(func: T, wait: number): (...args: Parameters<T>) => void {
  ...
  return function (this: ThisParameterType<T>, ...args: Parameters<T>) {
    ...
    timeout = setTimeout(() => func.apply(this, args), wait) as unknown as ReturnType<typeof setTimeout>;
  };
}
...
class App {
  ...
  createMedias(
    ...
    const defaultItems = [
      {
        image: `https://res.cloudinary.com/travelee/image/upload/v1739969088/image_1_ojx8yg.png`,
        text: "Chai Corner",
      },
      {
...
const CircularGallery: React.FC<CircularGalleryProps> = ({ items = [], bend = -3, textColor = "#ffffff", borderRadius = 0.05, font = "bold 30px DM Sans" }) => {
